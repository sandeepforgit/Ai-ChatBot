...
startListening.onclick = async () => {
  ...
  recognition.onresult = async (event) => {
    ...
    console.log('User said:', userVoiceText);
...
const presenterInputByService = {
  talks: {
    source_url: 'https://m.media-amazon.com/images/S/aplus-media-library-service-media/f5e1033b-7f95-47c7-b037-59c93dcd2ae8.__CR0,0,300,300_PT0_SX300_V1___.jpg',
  },
  clips: {
...
const startPlay = async (geminiResponse) => {
